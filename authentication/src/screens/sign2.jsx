...
function SignTwo() {
    ...
    function handleSubmit() {
        ...
        if (inputs.password.value && inputs.cPassword.value && inputs.name.value && inputs.cPassword.isValid && inputs.password.isValid) {
            const data = {
        ...
        <AlertNotificationRoot>
            ...
            <View style={{ backgroundColor: GlobalColors.bg, flex: 1 }}>
                <View className="py-24 px-8 flex flex-col justify-center items-center">
                    ...
                    <View className="rounded-lg px-2 py-3 w-full mt-8" style={{ backgroundColor: GlobalColors.primary }}>
